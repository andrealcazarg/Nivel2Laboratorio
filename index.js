...
function validar(campo) {
    ...
    if (campo.value) {
        //si existe nombre OK. si existe password tengo que validar:
        //1:que tenga al menos 8 caracteres y que password y confirm_password sean iguales.
        //2:que el email sea valido
        ...
        if (!(clave.value.length >= 8 && confir_clave.value.length >= 8) && (clave.value == confir_clave.value) && (clave.value.length != 0 || confir_clave.value.length != 0)) {
            ...
            clave.style.backgroundPosition = 'right 1% bottom 45%';
            clave.style.border = '3px solid red';
            confir_clave.style.backgroundImage = "url('images/success-icon.svg')";
            confir_clave.style.backgroundRepeat = 'no-repeat';
            confir_clave.style.backgroundPosition = 'right 1% bottom 45%';
            confir_clave.style.border = '3px solid green';
            ...
            campo.style.backgroundPosition = 'right 1% bottom 45%';
        ...
        if (validarEmail()) {
            ...
            email.style.backgroundPosition = 'right 1% bottom 45%';
